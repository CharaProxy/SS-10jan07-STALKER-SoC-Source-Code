...
void draw_background(Frect& back_text_coords, Frect& back_coords, Fvector2& back_size, ref_geom ll_hGeom, 
					 Fvector2& k, Fvector2& tsz)
{
	u32	Offset;
	u32	C						= 0xffffffff;
//progress background
...
//progress background
/*
		draw_background				(back_text_coords, back_coords, back_size, ll_hGeom, k, tsz);
/*/
		back_size.set				(1024,768);
		back_text_coords.lt.set		(0,0);back_text_coords.rb.add(back_text_coords.lt,back_size);
		back_coords.lt.set			(0,0);back_coords.rb.add(back_coords.lt,back_size);
